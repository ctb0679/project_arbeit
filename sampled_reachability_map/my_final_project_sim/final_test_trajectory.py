...
def publish_joint_states():
    ...
    waypoints = []
    waypoint_file_path = '/home/junaidali/inspection_ws/src/scientific-working-ss-2024/my_final_project_sim/generated_joint_states_new.txt'  # <-- Replace this with actual path
