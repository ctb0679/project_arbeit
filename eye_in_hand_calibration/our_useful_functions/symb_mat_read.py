...
with open(additional_dir + "our_useful_functions/src/our_useful_functions/symb_jacobian.txt", "r") as inf:
    J = sp.Matrix(sp.sympify(inf.read()))

with open(additional_dir + "our_useful_functions/src/our_useful_functions/symb_transform.txt", "r") as inf:
    A = sp.Matrix(sp.sympify(inf.read()))

with open(additional_dir + "our_useful_functions/src/our_useful_functions/symb_transform_matrix.txt", "r") as inf:
